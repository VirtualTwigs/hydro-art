...
(function (global) {
  ...
  const COUNTIES = {
    ...
    Maryland: ["Allegany","Anne Arundel","Baltimore","Baltimore (city)","Calvert","Caroline","Carroll",
    ...
    Virginia: ["Accomack","Albemarle","Alexandria","Alleghany","Amelia","Amherst","Appomattox",
      ...
      "Emporia","Essex","Fairfax","Fairfax (city)","Falls Church","Fauquier","Floyd","Fluvanna",
      "Franklin","Franklin (city)","Frederick","Fredericksburg","Galax","Giles","Gloucester",
      ...
      "Richmond","Richmond (city)","Roanoke","Roanoke (city)","Rockbridge","Rockingham","Russell","Salem",
    ...
    Missouri: ["Adair","Andrew","Atchison","Audrain","Barry","Barton","Bates","Benton","Bollinger",
      ...
      "Shannon","Shelby","St. Charles","St. Clair","St. Francois","St. Louis","St. Louis (city)",
