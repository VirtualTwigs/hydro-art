...
IMPORTANT: Ensure the product mission and roadmap are ALIGNED and DO NOT CONFLICT with the user's preferences, architecture, and invariants as detailed in the following files:
