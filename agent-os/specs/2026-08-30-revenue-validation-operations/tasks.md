...
- [ ] `fulfillment-pack/listing.md` — title, description, size/format/add-on options,
...
- [ ] Rights check: no PRISM-derived art listed; attribution present on every asset.

## TG3 — Instrumentation (#58)
- [ ] `fulfillment-pack/instrumentation.md` — the weekly funnel + per-order + per-inquiry
...
## TG4 — Revenue gate (#59)
- [ ] `fulfillment-pack/gate.md` — the 60-day evaluation procedure (≥8 orders or ≥$500
